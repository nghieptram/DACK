    ...
    <?php endforeach; ?> -->
                ...
                <div class="card ms-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">Bạn đã gửi yêu cầu kết bạn với <a
                                        href="profile.php?id=<?php echo $notify['forUserID'] ?>">
                                        <?php echo $notify['fullname'] ?> </a> </p>
                                <p class="card-text"><small
                                        class="text-muted"><?php echo $notify['createdAt'] ?></small></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                  ...
                  <?php $countNoti++ ?>
                <?php endforeach; ?>
                <?php setcookie("coutNotify", $countNoti);?>
    ...
    <!-- <div class="row">
      <div class="col-5"> -->
                    <a href="conversation.php?id=<?php echo $conversation['id'] ?>"
                        style="font-size: 20px; float: left;"><?php echo $conversation['fullname'] ?></a>
                    <!-- </div>
      <div class="col-7"> -->
  ...
  <?php echo $conversation['lastMessage']['content'] ?>
        ...
        <div class="card ms-3" style="max-width: 540px;">
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <a href="profile.php?id=<?php echo $notify['fromUserID'] ?>">
                            <h5 class="card-title"><?php echo $notify['fullname'] ?></h5>
                        </a>
                        <p class="card-text">Đã gửi yêu cầu kết bạn với bạn.</p>
                        <p class="card-text"><small class="text-muted"><?php echo $notify['createdAt'] ?></small></p>
                    </div>
    ...
    <h4 class="card-title">
      <!-- <div class="row">
        ...
        <a href="conversation.php?id=<?php echo $conversation['id'] ?>" style="text-decoration: none; color: black">
            ...
            <br>
            <form style="background-color: rgba(192,192,192,0.4); padding: 1vw; margin-top: 1vw">
                <?php echo $conversation['lastMessage']['content'] ?>
            </form>
        </a>
    </div>
