...
<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <button type="button"  class="btn btn-outline-primary" style="margin-right: 2vw; margin-left: 5vw">Hình Ảnh</button>
        <button type="button" class="btn btn-outline-secondary" style="margin-right: 2vw">Cảm Xúc</button>
